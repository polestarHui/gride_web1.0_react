...
let transferTool = {
   ...
   * */
  trans54ToGaode(x, y){
    const temp = 100000000000;
    let lng = 0.0000116476464 * x * temp + 110.539480605598 * temp;
    let lat = 0.00000898701567 * y * temp + 37.1774484832782 * temp;
    return [lng / temp, lat / temp];
  },
  transGaodeTo54(lng, lat){
    let x = 85854.25448001 * lng - 9490284.698001146;
    let y = 111271.64309999 * lat - 4136795.7789995605;
    return [x, y];
  }
};
